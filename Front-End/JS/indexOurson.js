...
function addCarte(value) {
  ...
  for (FicheOurson of value) {
    ...
    <div class="col-sm-6 p-3 mb-5 card">
      <a href="./Front-End/Pages/produit.html?_id=${FicheOurson._id}" class="text-center">
      ...
      <a href="./Front-End/Pages/produit.html?_id=${FicheOurson._id}" class="btn btn-outline-success">Acheter ce produit</a>
    </div>`;
